...
def create_model(args, bert_config, num_labels, is_prediction=False, k=0, n=0, q=0,task_name=""):
    input_fields = {
    ...
    if task_name == "fewshot":
        ...
        logits = fluid.layers.reshape(logits, [-1, q*k, k, n, 2], inplace=True)
        ...
        accuracy = fluid.layers.accuracy(input=probs, label=labels, k=1, total=num_seqs)
